...
## Project Structure
    ...
    ├── cool_wildflower_dev_98766  # Django project configurations
...
1. Clone this repo and `cd cool_wildflower_dev_98766`
...
2. Clone this repo and `cd cool_wildflower_dev_98766`
